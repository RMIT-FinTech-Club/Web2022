        ...
        <section className='' data-aos='fade-up' id="upcoming">
            ...
            <Row>
                <Col lg={4} className="upcoming-col">
                    <div className="bg-secondary ft-shadow-1 py-4 h-100 inverted-border-radius" data-aos="slide-up" data-aos-duration="6000">
                    ...
                    <div className="bg-ft-skyblue ft-shadow-1 py-4 h-100 inverted-border-radius-2" data-aos="slide-up" data-aos-duration="6000">
                    ...
                    <div className="bg-ft-gray ft-shadow-1 py-4 h-100 inverted-border-radius-3" data-aos="slide-up" data-aos-duration="6000">
