            ...
            <div className='container'>
                ...
                */}
                ...
                <div className='mt-5'>
                    ...
                    {
                        current_month_events && current_month_events.map((e,i) => {
                            return (<SingleEventBlock key={i}
                                name={e.name} 
                                date={e.date} 
                                time={e.time} 
                                location={e.location} />)
                ...
                <div className='mt-5'>
                    ...
                    {
                        next_month_events && next_month_events.map((e,i) => {
                            return (<SingleEventBlock key={i}
                                name={e.name} 
                                date={e.date} 
                                time={e.time} 
                ...
                */}
                ...
                <div className='mt-5'>
                    ...
                    {
                        past_2month_events && past_2month_events.map((e,i) => {
                            return (<SingleEventBlock key={i}
                                name={e.name} 
                                date={e.date} 
                                time={e.time} 
                ...
                <div className='mt-5'>
                    ...
                    {
                        past_month_events && past_month_events.map((e,i) => {
                            return (<SingleEventBlock key={i}
                                name={e.name} 
                                date={e.date} 
                                time={e.time} 
